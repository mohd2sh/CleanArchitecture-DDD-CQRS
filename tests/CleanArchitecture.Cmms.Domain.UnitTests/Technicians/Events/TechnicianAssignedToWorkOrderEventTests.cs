...
namespace CleanArchitecture.Cmms.Domain.UnitTests.Technicians.Events
{
    public class TechnicianAssignedToWorkOrderEventTests
    {
        ...
        public void Ctor_Should_Set_Properties_And_Default_Null_Timestamp()
        {
            ...
            // Act
            TechnicianAssignedToWorkOrderEvent domainEvent = new TechnicianAssignedToWorkOrderEvent(technicianId, workOrderId);
        ...
        public void Ctor_Should_Respect_Provided_Timestamp()
        {
            ...
            // Act
            TechnicianAssignedToWorkOrderEvent domainEvent = new TechnicianAssignedToWorkOrderEvent(technicianId, workOrderId, providedTimestamp);
