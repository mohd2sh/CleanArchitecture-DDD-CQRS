...
namespace CleanArchitecture.Core.ArchitectureTests.Domain;

/// <summary>
/// Base class for domain layer architecture tests.
/// Inherit from this class and provide the domain assembly and forbidden assemblies.
/// </summary>
/// <example>
/// <code>
/// public class DomainArchitectureTests : DomainArchitectureTestBase
/// {
///     protected override Assembly DomainAssembly => typeof(YourDomainType).Assembly;
...
/// </code>
/// </example>
public abstract class DomainArchitectureTestBase
{
    /// <summary>
    /// The domain assembly to test. Must be provided by the consumer.
    /// </summary>
    protected abstract Assembly DomainAssembly { get; }

    /// <summary>
    /// Assemblies that the domain should NOT depend on (e.g., Application, Infrastructure).
    ...
    public void Domain_Should_Not_Depend_On_Other_Layers()
    {
        ...
        Assert.True(result.IsSuccessful,
            $"Domain layer must not depend on: {string.Join(", ", forbiddenAssemblyNames)}");
    }
